<x-guest-layout>
    <div class="max-w-md w-full mx-auto bg-white dark:bg-slate-800 p-8 rounded-[28px] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.04)] border border-slate-100/50 dark:border-slate-700/50 transition-colors duration-300">
        ...
        <div class="text-center mb-8">
            <h2 class="text-2xl font-bold text-slate-800 dark:text-white tracking-tight transition-colors">Create New Password</h2>
            <p class="text-sm text-slate-400 mt-1.5 transition-colors">Please enter your new security credentials.</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="mb-4">
                <div class="relative flex items-center">
                    <span class="absolute left-4 flex items-center justify-center text-slate-400 dark:text-slate-500 w-5 h-5">
                    ...
                    <input id="email" class="block w-full pl-12 pr-4 py-3.5 bg-slate-100 dark:bg-slate-900/80 border-transparent dark:border-slate-700 rounded-2xl text-sm text-slate-500 dark:text-slate-400 cursor-not-allowed transition-colors" 
                           type="email" 
                           name="email" 
            ...
            <div class="mb-4">
                <div class="relative flex items-center">
                    ...
                    <input id="password" class="block w-full pl-12 pr-12 py-3.5 bg-slate-50 dark:bg-slate-900/50 border-transparent dark:border-slate-700 focus:border-slate-200 dark:focus:border-slate-600 focus:bg-white dark:focus:bg-slate-900 focus:ring-0 rounded-2xl text-sm text-slate-700 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 transition-all duration-200"
                           ...
                           required />
                    <span class="absolute right-4 flex items-center justify-center text-slate-400 dark:text-slate-500 cursor-pointer w-5 h-5 toggle-password-btn" data-target="password">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
            ...
            <div class="mb-6">
                <div class="relative flex items-center">
                    ...
                    <input id="password_confirmation" class="block w-full pl-12 pr-12 py-3.5 bg-slate-50 dark:bg-slate-900/50 border-transparent dark:border-slate-700 focus:border-slate-200 dark:focus:border-slate-600 focus:bg-white dark:focus:bg-slate-900 focus:ring-0 rounded-2xl text-sm text-slate-700 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 transition-all duration-200"
                           ...
                           required />
                    <span class="absolute right-4 flex items-center justify-center text-slate-400 dark:text-slate-500 cursor-pointer w-5 h-5 toggle-password-btn" data-target="password_confirmation">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                        </svg>
